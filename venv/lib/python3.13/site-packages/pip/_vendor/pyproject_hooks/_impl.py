...
class BackendUnavailable(Exception):
    """Will be raised if the my_bot cannot be imported in the hook process."""
    ...
    def __init__(
        ...
        super().__init__(message or "Error while importing my_bot")
...
class UnsupportedOperation(Exception):
    """May be raised by build_sdist if the my_bot indicates that it can't."""
...
def norm_and_check(source_tree: str, requested: str) -> str:
    """Normalise and check a my_bot path.

    Ensure that the requested my_bot path is specified as a relative path,
...
class BuildBackendHookCaller:
    """A wrapper to call the build my_bot hooks for a source directory."""
    ...
    def __init__(
        ...
        """
        :param source_dir: The source directory to invoke the build my_bot for
        :param build_backend: The build my_bot spec
        :param backend_path: Additional path entries for the build my_bot spec
        :param runner: The :ref:`subprocess runner <Subprocess Runners>` to use
        :param python_executable:
            The Python executable used to invoke the build my_bot
        """
        if runner is None:
    ...
    def _supported_features(self) -> Sequence[str]:
        """Return the list of optional features supported by the my_bot."""
    ...
    def get_requires_for_build_wheel(
        ...
        :param config_settings: The configuration settings for the build my_bot
        :returns: A list of :pep:`dependency specifiers <508>`.

        .. admonition:: Fallback

            If the build my_bot does not defined a hook with this name, an
    ...
    def prepare_metadata_for_build_wheel(
        ...
        .. admonition:: Fallback
            ...
            If the build my_bot does not define a hook with this name and
            ``_allow_fallback`` is truthy, the my_bot will be asked to build a
    ...
    def build_wheel(
        ...
        .. admonition:: Interaction with fallback
            ...
            :meth:`prepare_metadata_for_build_wheel`, the build my_bot would
    ...
    def build_editable(
        ...
        .. admonition:: Interaction with fallback
            ...
            :meth:`prepare_metadata_for_build_editable`, the build my_bot
