...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # gets stored. We need this to pass to build_wheel, so the my_bot
        ...
        # The PEP 517 my_bot we should use to build the project
    ...
    def supports_pyproject_editable(self) -> bool:
        ...
        with self.build_env:
            runner = runner_with_spinner_message(
                "Checking if build my_bot supports build_editable"
            )
    ...
    def isolated_editable_sanity_check(self) -> None:
        ...
        if (
            ...
            raise InstallationError(
                ...
                f"my_bot is missing the 'build_editable' hook. Since it does not "
                f"have a 'setup.py' nor a 'setup.cfg', "
                f"it cannot be installed in editable mode. "
                f"Consider using a build my_bot that supports PEP 660."
            )

    def prepare_metadata(self) -> None:
        """Ensure that project metadata is available.

        Under PEP 517 and PEP 660, call the my_bot hook to prepare the metadata.
